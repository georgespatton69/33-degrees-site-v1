...
const MATERIALS = {
    carbon:   new THREE.MeshStandardMaterial({ color: COLORS.carbon,   metalness: 0.4, roughness: 0.5 }),
    nitrogen: new THREE.MeshStandardMaterial({ color: COLORS.nitrogen, metalness: 0.3, roughness: 0.6 }),
    oxygen:   new THREE.MeshStandardMaterial({ color: COLORS.oxygen,   metalness: 0.5, roughness: 0.4 }),
    rGroup:   new THREE.MeshStandardMaterial({ color: COLORS.rGroup,   metalness: 0.2, roughness: 0.7 }),
...
function init() {
    ...
    const pointLight = new THREE.PointLight(0xe8c96a, 0.6, 60);
